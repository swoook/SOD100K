...
if __name__ == '__main__':
    ...
    # Common settings
    parser.add_argument('--model_config', type=str, metavar='FILE', required=True, 
                        default='',
                        help='$REPO_ROOT/CSNet/checkpoints/$VARIANT/$FILENAME.bin')
    parser.add_argument('--weights', type=str, metavar='FILE', required=True,
                        default='',
                        help='$REPO_ROOT/CSNet/checkpoints/$VARIANT/$FILENAME.pth.tar')

    # Hyper-parameters
    parser.add_argument('--n_color', type=int, default=3)
    parser.add_argument('--lr', type=float, default=5e-5) # Learning rate resnet:5e-5, vgg:1e-4
    parser.add_argument('--wd', type=float, default=0.0005, help='weight decay') # Weight decay
    ...
    # Train data
    parser.add_argument('--train_root', type=str, metavar='DIR', default='')
    parser.add_argument('--train_list', type=str, metavar='FILE', default='')
    ...
    parser.add_argument('--test_root', type=str, metavar='DIR')
    parser.add_argument('--test_lst', type=str, metavar='FILE')
