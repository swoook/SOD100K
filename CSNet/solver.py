...
class Solver(object):
    ...
    def build_model(self):
        self.net = build_model(predefine=self.config.model_config)
        self.net.to(self.device)
        self.net.load_state_dict(torch.load(self.config.weights, map_location=self.device)['state_dict'])
        ...
        self.print_network(self.net, '{}'.format( os.path.splitext(os.path.basename(self.config.model_config))[0] ))
