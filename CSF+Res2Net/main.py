...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=5e-5, help='initial learning rate') # Learning rate resnet:5e-5, vgg:1e-4
    parser.add_argument('--wd', type=float, default=0.0005, help='weight decay rate') # Weight decay
    parser.add_argument('--no-cuda', dest='cuda', action='store_false')

    # Training settings
    parser.add_argument('--pretrained_model', type=str, metavar='PATH', default=res2net_path)
    parser.add_argument('--epoch', type=int, default=24, help='maximum epoch number')
